...
.parse_json <- function(x, int64_T = 0L) {
    .Call(`_RcppSimdJson_parse_json`, x, int64_T)
}

.query_json <- function(x, json_pointer, int64_T = 0L) {
    .Call(`_RcppSimdJson_query_json`, x, json_pointer, int64_T)
}
